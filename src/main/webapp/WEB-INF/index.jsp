...
<div id="mainpage">
    <div id="number">
  		<div id="icon">
    		<div id="num">
	  			<img src="/resources/image/one.png" alt="1" width="100" height="100">
	  			<img src="/resources/image/two.png" alt="8" width="100" height="100">
	  			<img src="/resources/image/three.png" alt="2" width="100" height="100">
    		</div>
   			<div id="f">
   	   ...
   	   <div id="content">
  			  <p>「실종아동등의 보호 및 지원에 관한 법률」<br>제18조에 근거하여 실종아동등의 신상정보를 실종아동등을 찾기 위한 목적 외의 용도로 이용한 자는 2년 이하의 징역 또는 2천만원 이하의 벌금에 처할 수 있습니다.</p>
 		</div>
    </div>
	...
	<!-- 페이징 -->
 	...
 	<div id="pic">
       ...
       <img src="/resources/image/picreport.png" alt="My Image" width="25%" height="35%" onclick="location.href='/child/list'">
    </div>
